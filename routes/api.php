...
Route::get('/frontend-chatbot', [ChatbotController::class, 'frontendindex']);
Route::get('/frontend-chatbot/question/{id}', [ChatbotController::class, 'frontendquestion']);
Route::post('/frontend-chatbot/answer', [ChatbotController::class, 'answer']);